...
<body id="space" onkeydown="if(event.keyCode==27) return false;">
	...
	<!--{if $_G['uid']}-->
		<!--{template home/dashboard_user}-->
	<!--{else}-->
		<!--{template home/dashboard_guest}-->
	<!--{/if}-->
...
<ul id="navs_menu" class="nav_pop animated fadeInUp" style="display:none;"> <!-- p_pop topnav_pop -->
	<div class="upts" style="top:-9px;right:8px;"></div>
	<div class="upt" style="top:-8px;right:8px;"></div>
